...
$config['sess_save_path'] = sys_get_temp_dir(); // Pastikan path ini benar
$config['sess_match_ip'] = TRUE; // Hanya izinkan session dari IP yang sama
$config['sess_time_to_update'] = 300;
$config['sess_regenerate_destroy'] = TRUE; // Hancurkan session lama saat login ulang
