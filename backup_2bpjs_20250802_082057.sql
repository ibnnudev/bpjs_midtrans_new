...
CREATE TABLE `kepesertaan_bpjs` (
  ...
  `status_aktif` enum('Aktif','Tidak Aktif','Menunggu Aktivasi') NOT NULL DEFAULT 'Aktif',
...
CREATE TABLE `pembayaran_bpjs` (
  ...
  `status` enum('lunas','pending','gagal','review') DEFAULT 'pending',
  `status_kepesertaan` enum('Aktif','Tidak Aktif','Menunggu Aktivasi') DEFAULT 'Tidak Aktif',
...
INSERT INTO `pembayaran_bpjs` VALUES (6,16,'08-2025',300000.00,'2025-08-02 00:53:44','bank_transfer','registrasi','lunas','Aktif',NULL,'0998b527-5f61-41b2-9b68-0cdad11d967b','INV-1754096024');
...
-- Dump completed on 2025-08-02  1:20:57
